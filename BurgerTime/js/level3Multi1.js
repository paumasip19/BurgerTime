...
burgertime.level3Multi1 ={
    ...
    create:function(){
        ...
        this.changeDir1 = new burgertime.direcChanger(this.game,gameOptions.level1Width/19*1+30,gameOptions.level1Height/35*3.5,gameOptions.level1Height/35*8,'TileTransparente');
        this.changeDir2 = new burgertime.direcChanger(this.game,gameOptions.level1Width/19*1+30,gameOptions.level1Height/35*18.5,gameOptions.level1Height/35*6,'TileTransparente');
        this.changeDir3 = new burgertime.direcChanger(this.game,gameOptions.level1Width/19*3+30,gameOptions.level1Height/35*18.5,gameOptions.level1Height/35*6,'TileTransparente');
        this.changeDir4 = new burgertime.direcChanger(this.game,gameOptions.level1Width/19*5+30,gameOptions.level1Height/35*4,gameOptions.level1Height/35*6,'TileTransparente');
        this.changeDir5 = new burgertime.direcChanger(this.game,gameOptions.level1Width/19*5+30,gameOptions.level1Height/35*10.5,gameOptions.level1Height/35*10,'TileTransparente');
        this.changeDir6 = new burgertime.direcChanger(this.game,gameOptions.level1Width/19*5+30,gameOptions.level1Height/35*21,gameOptions.level1Height/35*8,'TileTransparente');
        this.changeDir7 = new burgertime.direcChanger(this.game,gameOptions.level1Width/19*7+30,gameOptions.level1Height/35*4,gameOptions.level1Height/35*3,'TileTransparente');
        this.changeDir8 = new burgertime.direcChanger(this.game,gameOptions.level1Width/19*7+30,gameOptions.level1Height/35*7.75,gameOptions.level1Height/35*8,'TileTransparente');
        this.changeDir9 = new burgertime.direcChanger(this.game,gameOptions.level1Width/19*7+30,gameOptions.level1Height/35*24.5,gameOptions.level1Height/35*4,'TileTransparente');
        this.changeDir10 = new burgertime.direcChanger(this.game,gameOptions.level1Width/19*9+30,gameOptions.level1Height/35*5.5,gameOptions.level1Height/35*10,'TileTransparente');
        this.changeDir11 = new burgertime.direcChanger(this.game,gameOptions.level1Width/19*11+30,gameOptions.level1Height/35*3.5,gameOptions.level1Height/35*3,'TileTransparente');
        this.changeDir12 = new burgertime.direcChanger(this.game,gameOptions.level1Width/19*11+30,gameOptions.level1Height/35*24.5,gameOptions.level1Height/35*4,'TileTransparente');
        this.changeDir13 = new burgertime.direcChanger(this.game,gameOptions.level1Width/19*13+30,gameOptions.level1Height/35*5.5,gameOptions.level1Height/35*6,'TileTransparente');
        this.changeDir14 = new burgertime.direcChanger(this.game,gameOptions.level1Width/19*13+30,gameOptions.level1Height/35*12,gameOptions.level1Height/35*16.5,'TileTransparente');
        this.changeDir15 = new burgertime.direcChanger(this.game,gameOptions.level1Width/19*17+30,gameOptions.level1Height/35*3.5,gameOptions.level1Height/35*8,'TileTransparente');
        this.changeDir16 = new burgertime.direcChanger(this.game,gameOptions.level1Width/19*17+30,gameOptions.level1Height/35*18,gameOptions.level1Height/35*6,'TileTransparente');
